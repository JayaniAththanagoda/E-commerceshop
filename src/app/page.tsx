...
import Phone from "@/componentss/Phone";
import { ArrowRight, Check, Star } from "lucide-react";
import Link from "next/link";
import Icons from "@/componentss/Icons";
          ...
          <div className="col-span-2 px-6 lg:px-0 lg:pt-4">
            <div className="relative mx-auto text-center lg:text-left flex flex-col items-center lg:items-start">
              ...
              <h1 className="relative w-fit tracking-tight text-balance mt-16 font-bold !leading-tight text-gray-900 text-5xl md:text-6xl lg:text-7xl">
                Your Image on a{" "}
                <span className="bg-green-600 px-2 text-white">Coustom</span>
                Phone Case
              </h1>
              <p className="mt-8 text-lg lg:pr-10 max-w-prose text-center lg:text-left text-balance md:text-wrap">
                capture your favarite memories with your own,{" "}
                <span className="font-semibold"> one-of-non</span> phone case.
      ...
      <section className="bg-slate-100 py-24">
        <MaxWidthWrapper className="flex flex-col items-center gap-16 sm:gap-32">
          <div className="flex flex-col lg:flex-row items-center gap-4 sm:gap-6">
            ...
            <img
              src="/users/snake-2.png"
              className="w-24 order-0 lg:order-2 "
            />
          </div>
          <div
            className="mx-auto grid max-w-2xl grid-cols-1 px-4 lg:max-0 
          ...
          >
            <div className="flex flex-auto flex-col gap-4 lg:pr-8 xl:pr-20">
              ...
              <div className="text-lg leading-8">
                <p>
                  ...
                  design. Had the case for two and a harf months now and
            ...
            <div className="flex flex-auto flex-col gap-4 lg:pr-8 xl:pr-20">
              ...
              <div className="text-lg leading-8">
                <p>
                  "I usually keep my phone together with my keeys in my pocket
                  and that led to some pretty heavy scratchmarks on all of my
                  scratch on the corner,{" "}
                  <span className="p-0.5 bg-slate-800 text-white ">
                    looks brand new after about harf a year
                  </span>{" "}
                  .I dig it."
                </p>
              </div>
              <div className="flex gap-4 mt-2">
                ...
                />
                <div className="flex flex-col">
                  <p className="font-semibold">Joshika</p>
                  <div className="flex gap-1.5 items-center text-zinc-600">
                    <Check className="h-4 w-4 stroke-[3px] text-green-600" />
                    <p className="text-sm">Verified purchase </p>
                  </div>
        ...
        <MaxWidthWrapper className="py-24">
          ...
          <div className="mx-auto max-w-6xl px-6 lg:px-8">
            ...
            >
              ...
              <Phone className="w-60" imgSrc="/users/horse.jpg" />
            </div>
          </div>
          <ul
          ...
          >
            ...
            <li className="w-fit">
              <Check className="h-5 text-green-600 inline mr-1.5" />5 years
              warranty
            </li>
